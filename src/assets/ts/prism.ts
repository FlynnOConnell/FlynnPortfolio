/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+csharp+cpp+css-extras+java+python+typescript+yaml&plugins=line-numbers+show-language+remove-initial-line-feed+previewers+normalize-whitespace+toolbar+copy-to-clipboard+download-button */
                ...
                if (pre.hasAttribute('data-' + key)) {
                    try {
                        var value = JSON.parse(
                            pre.getAttribute('data-' + key) || 'true'
                        );
