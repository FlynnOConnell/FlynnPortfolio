...
const getElevation = computed(() => (key: any) => (activetab.value === key ? 24 : 0));
...
Projects: [
    ...
    `,
        ...
        files: [
            {
                gist_id: "f4ba947d7ad3f4b8231c1f5bd85c876f",
                filename: "getWorkshopMaps.cpp",
                language: "cpp",
            },
            {
                gist_id: "f4ba947d7ad3f4b8231c1f5bd85c876f",
                ...
                <section id="PremierSuite" data-id="PremierSuite" class="project-content-container">
                    ...
                    <div id="row-container">
                        <v-container class="bg-background">
                            <v-row>
                                <v-col cols="12">
                                    <v-tabs v-model="activetab" dark class="rounded-lg d-flex">
                                        <v-tab key="1" href="#logic" class="rounded-lg flex-grow-1"
                                            :elevation="getElevation(1)">
                                            Logic
                                        </v-tab>
                                        <v-tab key="2" href="#workshops" class="rounded-lg flex-grow-1 "
                                            :elevation="getElevation(2)">
                                            Workshops
                                        </v-tab>
                                        <v-tab key="3" href="#gui-tree" class="rounded-lg flex-grow-1 "
                                            :elevation="getElevation(3)">
                                            GUI Tree
                                        </v-tab>
                                    </v-tabs>
                                </v-col>
                            ...
                            <v-row>
                                <v-col cols="12">
                                    ...
                                    <v-card v-show="activetab === 2" class="bg-surface">
                                        <template v-slot:title>
                                            Workshops
                                        </template>
                                        <template v-slot:subtitle>
